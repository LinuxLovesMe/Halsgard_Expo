            ...
            if((keyboard_key == vk_left) && !ui_password){
              ...
              if((ui_maxchar > 0 && string_length(ui_text) < ui_maxchar) or ui_maxchar == ui_default){
                switch(ui_acceptable){
                  ...
                  break;
                  default:
	if (keyboard_check_direct(vk_lshift) or keyboard_check_direct(vk_rshift))
	{
	switch (keyboard_key)
	{
		case 70: keyboard_string = chr(1040);
		break;

		case 188: keyboard_string = chr(1041);
		break;

		case 68: keyboard_string = chr(1042);
		break;

		case 85: keyboard_string = chr(1043);
		break;

		case 76: keyboard_string = chr(1044);
		break;

		case 84: keyboard_string = chr(1045);
		break;

		case 186: keyboard_string = chr(1046);
		break;

		case 80: keyboard_string = chr(1047);
		break;

		case 66: keyboard_string = chr(1048);
		break;

		case 81: keyboard_string = chr(1049);
		break;

		case 82: keyboard_string = chr(1050);
		break;

		case 75: keyboard_string = chr(1051);
		break;

		case 86: keyboard_string = chr(1052);
		break;

		case 89: keyboard_string = chr(1053);
		break;

		case 74: keyboard_string = chr(1054);
		break;

		case 71: keyboard_string = chr(1055);
		break;

		case 72: keyboard_string = chr(1056);
		break;

		case 67: keyboard_string = chr(1057);
		break;

		case 78: keyboard_string = chr(1058);
		break;

		case 69: keyboard_string = chr(1059);
		break;

		case 65: keyboard_string = chr(1060);
		break;

		case 219: keyboard_string = chr(1061);
		break;

		case 87: keyboard_string = chr(1062);
		break;

		case 88: keyboard_string = chr(1063);
		break;

		case 73: keyboard_string = chr(1064);
		break;

		case 79: keyboard_string = chr(1065);
		break;

		case 221: keyboard_string = chr(1066);
		break;

		case 83: keyboard_string = chr(1067);
		break;

		case 77: keyboard_string = chr(1068);
		break;

		case 222: keyboard_string = chr(1069);
		break;

		case 190: keyboard_string = chr(1070);
		break;

		case 90: keyboard_string = chr(1071);
		break;

		default: keyboard_string = keyboard_string;
		break;
	}
	}
                    ui_text = string_insert(keyboard_string, ui_text, ui_beam_position + 1);
